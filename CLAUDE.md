...
specs/004-patient-selection/plan.md
<!-- SPECKIT END -->

## Project Vision

**REQUIRED**: Before creating or updating any feature spec, plan, or task list, read
`summary.md` in the project root. It defines the product vision, target users, core user
